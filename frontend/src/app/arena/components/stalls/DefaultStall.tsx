...
const DefaultStall: React.FC<DefaultStallProps> = ({ stall, activeTile }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center h-[calc(100%-56px)] relative p-2">
        ...
        {/* Other decorations from the original Stall component */}
